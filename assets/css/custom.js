$(document).ready(function() {
	...
	$('.mobile-filter-area.filter-by h4').click(function(){
		$(this).parents('.mobile-short-by-area').find('.product-filter').toggleClass('active');
		$('body').toggleClass('stop-scroll');
		$('html').toggleClass('stop-scroll');
	})
	$('.close-filter').click(function(){
		$(this).parents('.mobile-short-by-area').find('.product-filter').removeClass('active');
		$('body').removeClass('stop-scroll');
		$('html').removeClass('stop-scroll');
	});
	$('.mobile-filter-area.short-by h4').click(function(){
		$(this).parents('.mobile-short-by-area').find('.short-area').toggleClass('active');
		$('body').toggleClass('stop-scroll');
		$('html').toggleClass('stop-scroll');
	})
	...
	$('.header-icons-area ul li a').click(function(){
	...
	$('.queries-content .card-header h5').click(function(){
		$('.queries-content .collapse').removeClass('show');
		$(this).parents('.card').find('.collapse').toggleClass('show');
	})
	$('.your-interest-listing ul li a').click(function(e){
		e.preventDefault();
		$(this).parent('li').toggleClass('active');
	})
